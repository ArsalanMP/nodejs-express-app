 ...
 *     description: Only models can create posts.
 *     tags: [Posts]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 ...
 *
 *   get:
 *     summary: Get all user (model) posts
 *     description: Only models can retrieve all their posts.
 *     tags: [Posts]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *   get:
 *     summary: Get a post
 *     description: Logged in users can fetch single post information by id.
 *     tags: [Posts]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in models can only update their own post.
 *     tags: [Posts]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in models can delete only their post.
 *     tags: [Posts]
 *     security:
 *       - bearerAuth: []
 *     parameters:
