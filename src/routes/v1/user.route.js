 ...
 *     description: Search in models by first name, last name and username user and return usernames
 *     tags: [Users]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 * /users/search/v2:
 *   get:
 *     summary: Search in models using js ( no db query )
 *     description: Search in models by first name, last name and username user and return usernames
 *     tags: [Users]
 *     security:
 *       - bearerAuth: []
 ...
 * /users/follow/{id}:
 *   post:
 *     summary: follow a model
 *     description: Logged in users can follow models by id.
 *     tags: [Users]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *
 *   delete:
 *     summary: unfollow a model
 *     description: Logged in users can unfollow models by id.
 *     tags: [Users]
 *     security:
 *       - bearerAuth: []
 *     parameters:
